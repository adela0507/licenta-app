...
function Experience(){
    return(
        ...
        <div className="title">
            ...
            <br /><br />
            <img className="expimage" src={img1} alt="" />
            <br /> <br /><br /><br />
            <ul>
            ...
            <section>
             ...
             <section>
                ...
                <p>In cadrul complexului Hadeu vei beneficia si de mancare calda oferita de cantina acesteia. Vei in apropiere si o sala de sport la care poti merge facandu-ti programare pe gratis</p>
                <p>Vei avea acces si la 2 spalatorii, fiind repartizat la una din acestea depinzand de caminul din care apartii.</p>
                <p>Ora pana la care e permis sa ai vizite este 23:00, insa nu ai ora de intrat in camin.</p>
                <br />
            </section>

            <h5>Ce mai astepti? Completeaza acum cererea pentru a beneficia de un loc intr-unul dintre camine.</h5>
